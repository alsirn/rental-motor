<x-layouts.app title="Katalog Motor">
    <section class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="mb-6 grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
                <p class="text-sm font-bold uppercase tracking-wide text-red-700">Katalog motor</p>
                <h1 class="mt-2 text-3xl font-black text-zinc-950 sm:text-4xl">Pilih Motor yang Tersedia</h1>
                <p class="mt-2 text-sm text-zinc-500">Filter berdasarkan brand, status ketersediaan, atau kata kunci.</p>
            </div>
