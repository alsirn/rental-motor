<x-layouts.app title="Rental Motor">
   <style>@keyframes float { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-12px); } }</style>
    <section class="relative w-full overflow-hidden border-b border-zinc-800 bg-[radial-gradient(circle_at_75%_50%,#b91c1c_0%,#7f1d1d_35%,#450a0a_65%,#09090b_100%)] px-6 py-8 sm:py-10">
        <div class="mx-auto flex max-w-7xl flex-col lg:flex-row items-center justify-between gap-10">
            <div class="flex w-full max-w-2xl flex-1 flex-col gap-5">
                <div><span class="inline-block rounded-md border border-red-700/50 bg-red-500/25 px-3.5 py-1.5 text-[11px] font-extrabold uppercase tracking-widest text-red-200">Rental Motor</span></div>
                <h1 class="text-4xl font-black leading-tight tracking-tight text-white sm:text-5xl">Sewa Motor<br><span class="text-red-500 drop-shadow-[0_0_20px_rgba(239,68,68,0.4)]">Cepat.</span><br>Data <span class="text-red-500 drop-shadow-[0_0_20px_rgba(239,68,68,0.4)]">Rapi.</span></h1>
                <p class="max-w-xl text-sm leading-6 text-zinc-300">Temukan motor yang sesuai kebutuhanmu dengan proses penyewaan yang cepatdan pengelolaan data yang rapi.</p>
            ...
            <div class="relative flex min-h-[260px] w-full flex-1 items-center justify-center lg:min-h-[330px]">
            <div class="absolute inset-8 rotate-[-4deg] rounded-2xl border-2 border-red-500/70 shadow-[0_0_20px_rgba(239,68,68,0.3)] transition duration-500 hover:rotate-0 hover:shadow-[0_0_45px_rgba(239,68,68,0.6)]"></div>
                <div class="relative z-10 w-full animate-[float_4s_ease-in-out_infinite] text-center">
                    @if ($heroBanner)
                        <img src="{{ asset('storage/'.$heroBanner) }}" alt="Banner motor rental" class="mx-auto max-h-[350px] max-w-full object-contain drop-shadow-[0_20px_30px_rgba(0,0,0,0.7)]">
                    @else
        ...
        <div class="mx-auto max-w-6xl">
            <div class="scroll-animate grid grid-cols-1 overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-[0_15px_50px_rgba(0,0,0,0.06)] dark:border-zinc-800 dark:bg-zinc-900 md:grid-cols-3">
                <div class="group flex items-center gap-4 border-b border-zinc-200 p-6 transition-all duration-300 hover:bg-red-50/50 dark:border-zinc-800 dark:hover:bg-red-950/10 md:border-b-0 md:border-r">
                    <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-red-100 text-red-600 transition duration-300 group-hover:scale-110 group-hover:bg-red-600 group-hover:text-white dark:bg-red-950/50 dark:text-red-700">
                        <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                    </div>
                    <div>
                        <p class="text-2xl font-black text-red-600 dark:text-red-700">100%</p>
                ...
                <div class="group flex items-center gap-4 border-b border-zinc-200 p-6 transition-all duration-300 hover:bg-red-50/50 dark:border-zinc-800 dark:hover:bg-red-950/10 md:border-b-0 md:border-r">
                    ...
                    <div>
                        <p class="text-2xl font-black text-red-600 dark:text-red-700">Cepat</p>
                ...
                <div class="group flex items-center gap-4 p-6 transition-all duration-300 hover:bg-red-50/50 dark:hover:bg-red-950/10">
                    ...
                    <div>
                        <p class="text-2xl font-black text-red-600 dark:text-red-700">Aman</p>
    ...
    <section class="bg-zinc-50 px-4 py-16 dark:bg-zinc-900 sm:px-6">
        <div class="mx-auto max-w-6xl">
            <div class="scroll-animate mb-10 text-center">
                <span class="inline-flex rounded-full bg-red-50 px-4 py-2 text-[11px] font-black uppercase tracking-[0.18em] text-red-600 dark:bg-red-950/40 dark:text-red-700">Kenapa Kami?</span>
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <div class="scroll-animate rental-card group rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:border-zinc-800 dark:bg-zinc-950">
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-red-50 text-red-600 transition duration-300 group-hover:scale-110 group-hover:bg-red-600 group-hover:text-white dark:bg-red-950/40 dark:text-red-700">
        ...
        <div class="mx-auto max-w-6xl">
            <div class="grid items-center gap-10 lg:grid-cols-2">
                <div class="scroll-animate">
                    <span class="inline-flex rounded-full bg-red-50 px-4 py-2 text-[11px] font-black uppercase tracking-[0.18em] text-red-600 dark:bg-red-950/40 dark:text-red-700">Pengalaman Lebih Baik</span>
                    <h2 class="mt-5 text-3xl font-black leading-tight tracking-tight text-zinc-900 dark:text-white sm:text-4xl">Semua yang Kamu Butuhkan,<span class="text-red-600 dark:text-red-700">Ada di Sini.</span></h2>
                    ...
                    <div class="relative overflow-hidden rounded-[2rem] border border-zinc-200 bg-zinc-50 p-6 shadow-xl dark:border-zinc-800 dark:bg-zinc-900">
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div class="rental-card rounded-2xl border border-zinc-200 bg-white p-5 transition hover:-translate-y-1 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-950">
                                <p class="text-2xl font-black text-red-600 dark:text-red-700">24/7</p>
                            ...
                            <div class="rental-card rounded-2xl border border-zinc-200 bg-white p-5 transition hover:-translate-y-1 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-950">
                                <p class="text-2xl font-black text-red-600 dark:text-red-700">Mudah</p>
                            ...
                            <div class="rental-card rounded-2xl border border-zinc-200 bg-white p-5 transition hover:-translate-y-1 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-950">
                                <p class="text-2xl font-black text-red-600 dark:text-red-700">Ready</p>
    ...
    <section class="bg-zinc-50 px-4 py-16 dark:bg-zinc-900 sm:px-6">
        <div class="mx-auto max-w-6xl">
            <div class="scroll-animate mx-auto mb-10 max-w-2xl text-center">
                <span class="inline-flex rounded-full bg-red-50 px-4 py-2 text-[11px] font-black uppercase tracking-[0.18em] text-red-600 dark:bg-red-950/40 dark:text-red-700">Cara Sewa</span>
