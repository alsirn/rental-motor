        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <h1 class="mt-1 text-2xl font-bold text-zinc-900 dark:text-white">Kelola Brand / Tipe</h1>
            ...
            <div class="grid gap-6 lg:grid-cols-[360px_1fr]">
                <div class="rounded-xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    <div class="border-b border-zinc-200 px-5 py-4 dark:border-zinc-800">
                        <h2 class="text-base font-semibold text-zinc-900 dark:text-white">Tambah Brand</h2>
                ...
                <div class="rounded-xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    <div class="border-b border-zinc-200 px-5 py-4 dark:border-zinc-800">
                        <h2 class="text-base font-semibold text-zinc-900 dark:text-white">Daftar Brand</h2>
            ...
            document.getElementById('brand-list').innerHTML = brands.map(brand => `
                <div class="flex items-center justify-between gap-4 px-5 py-4 transition hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                    <div class="flex min-w-0 items-center gap-3">
                        <div class="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-red-50 text-sm font-bold text-red-600 dark:bg-red-950/40 dark:text-red-400">${brand.nama_brand.charAt(0).toUpperCase()}</div>
                        <div class="min-w-0">
